...
class _GameDetailsPageState extends ConsumerState<GameDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      onPopInvokedWithResult: (result, dynamic) {
        ref.read(gameNotifierProvider.notifier).emptyGameDetails();
      },
      child: Scaffold(
        appBar: AppBar(
        ...
        body: AppLoader(
          isLoading: ref.watch(gameNotifierProvider.select((value) => value.isLoading)),
          child: Container(
